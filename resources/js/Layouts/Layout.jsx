...
useEffect(() => {
  ...
  return (
    <div className="container lg:max-w-screen w-[80%] mx-auto">
<header
            ...
            {auth.user ? (
              ...
              <div className="relative flex items-center">
                ...
                <div onClick={togglemodel} className="absolute z-50 top-16  -right-4 border dark:border-slate-200 bg-white dark:bg-slate-800 dark:text-white rounded-lg overflow-hidden w-40">
                  ...
                  <Link href={route('admin.page')} className="lg:hidden block w-full px-6 py-3 dark:hover:bg-slate-700 hover:bg-gray-200/20 text-left text-gray-800/80 dark:text-white">Dashboard</Link>
                   }
