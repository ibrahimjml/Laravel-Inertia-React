...
export default function CreateUsermodel({roles,closemodel}) {
  ...
  <div className="fixed inset-0 z-50 bg-black bg-opacity-20 flex items-center justify-center">
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg w-[40%] max-h-[80vh]  overflow-y-auto relative scrollbar-dark">
        <button
          onClick={closemodel}
        ...
        <h3 className="text-lg font-bold mb-4 text-center">Create New User</h3>
          {/* Form */}
        <form onSubmit={handleSubmit} className="space-y-4">
            <div className="flex flex-wrap">
                    ...
                    <div className="flex flex-wrap">
                        <label htmlFor="password" className="block text-white text-sm font-bold mb-2 sm:mb-4">
                          Password:
                        </label>
                    ...
                    <div className="flex flex-wrap">
                        <label htmlFor="password-confirm" className="block text-white text-sm font-bold mb-2 sm:mb-4">
                          Confirm-password:
                        </label>
