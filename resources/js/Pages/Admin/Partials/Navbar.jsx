  ...
  <div className='bg-white flex items-center justify-between mx-auto p-8 rounded-lg shadow-lg dark:bg-slate-800 mb-4'>
    ...
    <p className='text-3xl text-black dark:text-slate-200 capitalize'>posts reports</p>
      ...
      <div className="flex justify-end gap-2 ">
        ...
        <Link href={route('posts.reports')} className={`block w-full px-6 py-3  rounded-lg tracking-[1px] ${route().current('posts.reports') ? 'bg-slate-600 font-bold text-white':'hover:bg-slate-700 hover:text-white'} capitalize`}>p.reports</Link>
        <Link href={route('comments.reports')} className={`block w-full px-6 py-3  rounded-lg tracking-[1px] ${route().current('comments.reports') ? 'bg-slate-600 font-bold text-white':'hover:bg-slate-700 hover:text-white'} capitalize`}>c.reports</Link>
