                        ...
                        <section className="flex flex-col break-words bg-white sm:border-1 sm:rounded-lg  sm:shadow-lg">
                            ...
                            >
                                <div className="flex flex-wrap">
                                    <label
                                        htmlFor="email"
                                        className="block text-gray-700 text-sm font-bold mb-2 mt-4 sm:mb-4"
                                    >
                                        E-Mail Address:
                                    </label>
                                ...
                                <div className="flex justify-center flex-wrap">
                                    ...
                                    <p className="w-full text-xs text-center text-gray-700 my-6 sm:text-sm sm:my-8">
                                        ...
                                        <Link
                                            className="text-gray-500 ml-2 hover:text-blue-700 no-underline hover:underline"
                                            href={route("register")}
                                        >
                                            Register
                                        </Link>
                                    ...
                                    <p className="text-center mb-2">
                                        <Link
                                            className="text-gray-500 text-center mb-2 hover:text-blue-700 no-underline hover:underline"
